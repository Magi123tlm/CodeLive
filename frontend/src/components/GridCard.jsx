...
const GridCard = ({ item }) => {
  ...
  return (
    <>
      <div className="gridCard bg-[#141414] p-[10px] cursor-pointer hover:bg-[#202020] w-[270px] h-[180px] rounded-lg shadow-lg shadow-black/50">
        <div onClick={() => navigate(`/editor/${item._id}`)}>
          <img className="w-[85px]" src={codeImg} alt="" />
